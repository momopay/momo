...
* Update translations, see [translation_process.md](https://github.com/momopay/momo/blob/master/doc/translation_process.md#syncing-with-transifex)
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/momopay/gitian.sigs.git
...
### Build and sign Momo Core for Linux, Windows, and OS X:
	...
	./bin/gbuild --commit momo=v${VERSION} ../momo/contrib/gitian-descriptors/gitian-osx.yml
...
Commit your signature to gitian.sigs:
  ...
  Wait for Windows/OS X detached signatures:
	...
	Detached signatures will then be committed to the [momo-detached-sigs](https://github.com/momopay/momo-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Momo-development mailing list

  - Update title of #momopay on Freenode IRC
