...
git clone https://github.com/desirepay/momo
```
...
```bash
    ...
    From https://github.com/desirepay/momo
...
and the momo git repository with the desired tag must both be available locally, and then gbuild must be
...
[momo/gitian.sigs](https://github.com/desirepay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
