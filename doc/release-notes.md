Momo Core version 0.12.2.2
==========================

Release is now available from:

  <https://www.momo-crypto.com/downloads>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/lazyboozer/Momo/issues>
...
desired/momo-qt (on Linux). Because of the per-UTXO fix (see below) there is a
...
To fix this issue in Momo Core however, we had to backport a lot of other
...
Keeping a wallet with 1000 MOC unlocked for 24/7 is definitely not a good idea
...
it should be possible to compile Momo Core with `--disable-wallet` option now.
...
See detailed [change log](https://github.com/lazyboozer/Momo/tree/master/doc/release-notes/release-notes-0.12.2.2) below.

Backports:

- Align with btc 0.12 (#1409)
- Fix for Momo-qt issue with startup and multiple monitors. (#1461)
...
- Backport Bincoin PR#7348: MOVE ONLY: move rpc* to rpc/ + same for Momo-specific rpc (#1502)
...
- Eliminate remaining uses of g_connman in Momo-specific code. (#1635)
...
- Fix windows installer script, should handle Momo: uri correctly now (#1550)
...
- Ensure Momo wallets < 0.12.2 can't open HD wallets (#1638)
