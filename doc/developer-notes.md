...
Momo Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 7717.
...
However, in open source software such as Momo Core, where everyone uses
...
pay attention to for reviewers of Momo Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Momo Core uses tinyformat, which is type safe. Leave them out to avoid confusion
