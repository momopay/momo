...
Only requiring some minor changes is momo.cpp.
...
Changes to momo.cpp
----------------------
momo.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
