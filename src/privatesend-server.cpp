...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Momo related functionality
...
/*
    ...
    allow endless transaction that would bloat Momo and make it unusable. To
