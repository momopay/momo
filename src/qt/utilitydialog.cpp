    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Momo Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Momo Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  momo-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Momo in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MOC, 0.1 MOC, 1 MOC and 10 MOC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://desirepay.atlassian.net/wiki/display/DOC/PrivateSend\">https://desirepay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Momo Core is shutting down...") + "<br /><br />" +
