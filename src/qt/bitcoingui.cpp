    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Momo Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Momo address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and momo: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Momo Core"), this);
    aboutAction->setStatusTip(tr("Show information about Momo Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Momo Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Momo addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Momo addresses"));
    ...
    openAction->setStatusTip(tr("Open a momo: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Momo Core help message to get a list with possible Momo Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Momo Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Momo network", "", count));
    } else {
...
{
    QString strTitle = tr("Momo Core"); // default title
