 ...
 *
 *   // network
 *   CDesireNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.momo.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CDesireNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: DesireNetwork
// //   -- signature requirements : Key1(User)
// class CDesireNetworkVariable : public CGovernanceObject
// {
// private:
