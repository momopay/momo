...
{
    const char* pszTimestamp = "Momo cryptocurrency start 09.03.2018";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1520438400,  3553636, 0x1e0ffff0, 1, 50 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000030556602a6e39ce3bbaef7c632580dbc8868787e12c6bec53b849b2c978"));
        assert(genesis.hashMerkleRoot == uint256S("0x73319cd5f2276c45ceaa2366c7e7c65df1b2d065b5c8e5c2d3b5734d45a21a10"));
		...
		vSeeds.push_back(CDNSSeedData("seed9.hellolua.com", "seed9.hellolua.com"));
        ...
        vSeeds.push_back(CDNSSeedData("seed2.hellolua.com", "seed2.hellolua.com"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (    0, uint256S("0x0000030556602a6e39ce3bbaef7c632580dbc8868787e12c6bec53b849b2c978")),
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1520438400,  559966, 0x1e0ffff0, 1, 50 * COIN);
   
        consensus.hashGenesisBlock = genesis.GetHash();
        // MineGenesisBlock(genesis);
        assert(consensus.hashGenesisBlock == uint256S("0x000007f1495cfe2189192d7fcb541aaffe99d98374d30c03403cb0cb2432abd4"));
        assert(genesis.hashMerkleRoot == uint256S("0x73319cd5f2276c45ceaa2366c7e7c65df1b2d065b5c8e5c2d3b5734d45a21a10"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x000007f1495cfe2189192d7fcb541aaffe99d98374d30c03403cb0cb2432abd4")),
